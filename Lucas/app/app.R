     ...
     output$Gameplay <- renderText({
       ...
       if(is.null(input$Tablo_rows_selected) == FALSE){
           url <- tablo() %>%
             ...
             str_replace_all("!", "%21") %>% 
             paste( "+gameplay")
          paste0("<br></br><a target= \"_blank\", class=\"yt-simple-endpoint style-scope ytd-topbar-logo-renderer\" id=\"logo\" href=\"https://www.youtube.com/results?search_query=",url,"\" title=\"Accueil YouTube\">
                <div class=\"style-scope ytd-topbar-logo-renderer\">
                <br></br><h2>Trouver un gameplay sur</h2>
                ...
                <ytd-yoodle-renderer class=\"style-scope ytd-topbar-logo-renderer\" hidden=\"\"><!--css-build:shady--><picture class=\"style-scope ytd-yoodle-renderer\">
